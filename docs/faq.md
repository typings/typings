...
- [How do I use typings with git and continuous integration?](#using-typings-with-version-control)
- [Should I commit the `typings` folder to git repository?](#using-typings-with-version-control)
...
## Using Typings with Version Control
